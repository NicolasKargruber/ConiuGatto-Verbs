...
if __name__ == "__main__":
    ...
    top100 = ["essere", "avere", "fare", "venire", "stare", "volere", "andare", "dire", "conoscere", "sapere", "vedere", "trovare", "dare", "pensare", "parlare", "mettere", "prendere", "portare", "arrivare", "chiedere", "credere", "lasciare", "sentire", "tenere", "diventare", "capire", "rimanere", "passare", "entrare", "lavorare", "vivere", "ricordare", "usare", "chiamare", "morire", "piacere", "guardare", "aprire", "seguire", "aspettare", "decidere", "scrivere", "finire", "mangiare", "bere", "leggere", "unire", "cambiare", "offrire", "giocare", "perdere", "provare", "cucinare", "rispondere", "nuotare", "succedere", "chiudere", "aiutare", "amare", "scegliere", "aggiungere", "mancare", "ricevere", "guidare", "iniziare", "ridere", "incontrare", "pagare", "crescere", "spiegare", "cadere", "colpire", "ascoltare", "fermare", "studiare", "vincere", "mandare", "correre", "girare", "ritornare", "comprare", "dimenticare", "vendere", "cominciare", "sedere", "odiare", "tirare", "sperare", "imparare", "dormire", "saltare", "durare", "cercare", "suonare", "mentire", "toccare", "lavare", "ballare", "costare", "cantare"]
    search_ids_in_verbs("coniugatto_verbs.json",  top100)